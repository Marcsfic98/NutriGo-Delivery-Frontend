    ...
    <>
      ...
      <div className="relative mt-16 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[url('img/banner/bghome.jpg')] bg-cover bg-center bg-no-repeat px-4 py-20 text-white">
        ...
        <div className="z-10 mb-10 text-center md:mb-20">
          ...
          <h1 className="-mt-2 text-5xl font-black tracking-tighter text-yellow-600 uppercase transition-all duration-700 md:-mt-4 md:text-7xl">
            {foodData[activeIndex]?.name}
          </h1>
          <p className="mx-auto mt-2 max-w-xs text-sm text-gray-200 italic md:max-w-none md:text-base">
      ...
      <section className="w-full bg-gray-100 py-12 md:py-20">
        <div className="mx-auto max-w-6xl px-6 text-center">
          ...
          <p className="mt-2 text-xs text-gray-500 md:text-sm">
            de 15.676 avaliações
          </p>
          <div className="mt-10 grid gap-6 md:mt-14 md:grid-cols-3">
            {reviews.map((review, index) => (
              <div
                key={index}
                className="rounded-3xl bg-white p-6 text-left shadow-md transition hover:shadow-lg md:p-8"
              >
